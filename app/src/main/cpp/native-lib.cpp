...
Java_com_example_appcalibracion3_MainActivity_setInternalPath(JNIEnv *env, jobject thiz, jstring path){
   jboolean isCopy;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_appcalibracion3_MainActivity_salt(JNIEnv *env, jobject thiz, jlong mat_addr_gray,
                                                  jint nbr_elem) {
   // TODO: implement salt()
...
Java_com_example_appcalibracion3_MainActivity_confdetector(JNIEnv *env, jobject thiz, jint a) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_example_appcalibracion3_MainActivity_detect(JNIEnv *env, jobject thiz, jlong mat_addr_gray,
                                                    jlong mat_addr_rgba) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_example_appcalibracion3_MainActivity_acceptCurrentDetection(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_appcalibracion3_MainActivity_limpiacapturas(JNIEnv *env, jobject thiz) {
